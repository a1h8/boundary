...
**Session Credential Brokering:** Boundary 0.4, adds a Vault integration for the brokering of [Vault](/vault) secrets to Boundary clients (both command line and desktop clients) for use
